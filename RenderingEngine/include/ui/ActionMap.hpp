...
namespace RenderingEngine::Ui
{
    ...
    enum class SemanticAction : std::uint16_t
    {
        ...
        CycleTransportModelForward,
        CycleTransportModelBackward,
        CycleExecutionArchitectureForward,
        CycleExecutionArchitectureBackward,
        CycleDirectLightingForward,
        CycleDirectLightingBackward,
        CycleLightSelectionForward,
        CycleLightSelectionBackward,
        CycleEnvironmentSamplerForward,
        CycleEnvironmentSamplerBackward,
        CycleShadowForward,
        CycleShadowBackward,
        ...
        SelectScene9,
        PrintCurrentReview,
        RestoreCurrentSceneRecommendedProfile,
        CycleSceneVariantForward,
        CycleSceneVariantBackward
    };
